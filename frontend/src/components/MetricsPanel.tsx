  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mt-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 bg-gray-50 rounded border border-gray-100">
          <p className="text-sm text-gray-500 mb-1">Retained Energy</p>
          <p className="text-xl font-bold font-mono">
        ...
        <div className="p-4 bg-gray-50 rounded border border-gray-100">
          ...
          <p className="text-xl font-bold font-mono">
            {metrics ? `${metrics.compression_ratio.toFixed(2)}x` : "-"}
          </p>
        </div>
        <div className="p-4 bg-gray-50 rounded border border-gray-100">
          <p className="text-sm text-gray-500 mb-1">MSE / PSNR</p>
          <div className="text-xl font-bold font-mono text-sm space-y-1">
            {metrics ? (
              <>
                <div>{metrics.mse.toFixed(2)}</div>
                <div>{metrics.psnr.toFixed(2)} dB</div>
              </>
            ) : "-"}
          </div>
        </div>
